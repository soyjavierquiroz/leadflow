...
export function FunnelButtonContent({
  text,
  subtext,
}: {
  text: ReactNode;
  ...
  return (
    <span
      className={cx(
        ...
        subtext ? "flex-col items-center justify-center gap-1" : "items-center justify-center",
      )}
    >
      <span className="block">{text}</span>
      {subtext ? (
        <span className="block text-[0.72em] font-normal leading-tight opacity-80 [text-transform:none]">
          {subtext}
        </span>
      ) : null}
    </span>
...
const primaryThemeButtonClassName =
  "font-button inline-flex items-center justify-center gap-[var(--theme-button-primary-gap)] border text-center no-underline [border-width:var(--theme-button-primary-border-width)] [border-radius:var(--theme-button-primary-rest-radius)] [background:var(--theme-button-primary-rest-bg)] [border-color:var(--theme-button-primary-rest-border)] px-[var(--theme-button-primary-padding-x)] py-[var(--theme-button-primary-padding-y)] [color:var(--theme-button-primary-rest-text-color)] [font-family:var(--theme-button-primary-rest-font-family)] [font-size:var(--theme-button-primary-rest-font-size)] [font-weight:var(--theme-button-primary-rest-font-weight)] [letter-spacing:var(--theme-button-primary-rest-letter-spacing)] [line-height:var(--theme-button-primary-rest-line-height)] [min-height:var(--theme-button-primary-min-height)] [text-transform:var(--theme-button-primary-rest-text-transform)] shadow-[var(--theme-button-primary-rest-shadow)] transition-all duration-[var(--theme-button-primary-motion-duration)] ease-[var(--theme-button-primary-motion-easing)] hover:[background:var(--theme-button-primary-hover-bg)] hover:[border-color:var(--theme-button-primary-hover-border)] hover:[color:var(--theme-button-primary-hover-text-color)] hover:shadow-[var(--theme-button-primary-hover-shadow)] hover:[transform:var(--theme-button-primary-motion-transform)] focus-visible:outline focus-visible:outline-[var(--theme-button-primary-border-width)] focus-visible:outline-[var(--theme-button-primary-outline-color)] focus-visible:[outline-offset:var(--theme-button-primary-outline-offset)] focus-visible:[background:var(--theme-button-primary-focus-bg)] focus-visible:[border-color:var(--theme-button-primary-focus-border)] focus-visible:[color:var(--theme-button-primary-focus-text-color)] focus-visible:shadow-[var(--theme-button-primary-focus-shadow)] disabled:cursor-not-allowed disabled:[background:var(--theme-button-primary-disabled-bg)] disabled:[border-color:var(--theme-button-primary-disabled-border)] disabled:[color:var(--theme-button-primary-disabled-text-color)] disabled:shadow-[var(--theme-button-primary-disabled-shadow)] disabled:[transform:none]";

const secondaryThemeButtonClassName =
  "font-button inline-flex items-center justify-center gap-[var(--theme-button-secondary-gap)] border text-center no-underline [border-width:var(--theme-button-secondary-border-width)] [border-radius:var(--theme-button-secondary-rest-radius)] [background:var(--theme-button-secondary-rest-bg)] [border-color:var(--theme-button-secondary-rest-border)] px-[var(--theme-button-secondary-padding-x)] py-[var(--theme-button-secondary-padding-y)] [color:var(--theme-button-secondary-rest-text-color)] [font-family:var(--theme-button-secondary-rest-font-family)] [font-size:var(--theme-button-secondary-rest-font-size)] [font-weight:var(--theme-button-secondary-rest-font-weight)] [letter-spacing:var(--theme-button-secondary-rest-letter-spacing)] [line-height:var(--theme-button-secondary-rest-line-height)] [min-height:var(--theme-button-secondary-min-height)] [text-transform:var(--theme-button-secondary-rest-text-transform)] shadow-[var(--theme-button-secondary-rest-shadow)] transition-all duration-[var(--theme-button-secondary-motion-duration)] ease-[var(--theme-button-secondary-motion-easing)] hover:[background:var(--theme-button-secondary-hover-bg)] hover:[border-color:var(--theme-button-secondary-hover-border)] hover:[color:var(--theme-button-secondary-hover-text-color)] hover:shadow-[var(--theme-button-secondary-hover-shadow)] hover:[transform:var(--theme-button-secondary-motion-transform)] focus-visible:outline focus-visible:outline-[var(--theme-button-secondary-border-width)] focus-visible:outline-[var(--theme-button-secondary-outline-color)] focus-visible:[outline-offset:var(--theme-button-secondary-outline-offset)] focus-visible:[background:var(--theme-button-secondary-focus-bg)] focus-visible:[border-color:var(--theme-button-secondary-focus-border)] focus-visible:[color:var(--theme-button-secondary-focus-text-color)] focus-visible:shadow-[var(--theme-button-secondary-focus-shadow)] disabled:cursor-not-allowed disabled:[background:var(--theme-button-secondary-disabled-bg)] disabled:[border-color:var(--theme-button-secondary-disabled-border)] disabled:[color:var(--theme-button-secondary-disabled-text-color)] disabled:shadow-[var(--theme-button-secondary-disabled-shadow)] disabled:[transform:none]";

export const heroHookPrimaryButtonClassName =
  "font-button inline-flex items-center justify-center gap-[var(--theme-section-hero-hook-primary-cta-gap)] border text-center no-underline [border-width:var(--theme-section-hero-hook-primary-cta-border-width)] [border-radius:var(--theme-section-hero-hook-primary-cta-rest-radius)] [background:var(--theme-section-hero-hook-primary-cta-rest-bg)] [border-color:var(--theme-section-hero-hook-primary-cta-rest-border)] px-[var(--theme-section-hero-hook-primary-cta-padding-x)] py-[var(--theme-section-hero-hook-primary-cta-padding-y)] [color:var(--theme-section-hero-hook-primary-cta-rest-text-color)] [font-family:var(--theme-section-hero-hook-primary-cta-rest-font-family)] [font-size:var(--theme-section-hero-hook-primary-cta-rest-font-size)] [font-weight:var(--theme-section-hero-hook-primary-cta-rest-font-weight)] [letter-spacing:var(--theme-section-hero-hook-primary-cta-rest-letter-spacing)] [line-height:var(--theme-section-hero-hook-primary-cta-rest-line-height)] [min-height:var(--theme-section-hero-hook-primary-cta-min-height)] [text-transform:var(--theme-section-hero-hook-primary-cta-rest-text-transform)] shadow-[var(--theme-section-hero-hook-primary-cta-rest-shadow)] transition-all duration-[var(--theme-section-hero-hook-primary-cta-motion-duration)] ease-[var(--theme-section-hero-hook-primary-cta-motion-easing)] hover:[background:var(--theme-section-hero-hook-primary-cta-hover-bg)] hover:[border-color:var(--theme-section-hero-hook-primary-cta-hover-border)] hover:[color:var(--theme-section-hero-hook-primary-cta-hover-text-color)] hover:shadow-[var(--theme-section-hero-hook-primary-cta-hover-shadow)] hover:[transform:var(--theme-section-hero-hook-primary-cta-motion-transform)] focus-visible:outline focus-visible:outline-[var(--theme-section-hero-hook-primary-cta-border-width)] focus-visible:outline-[var(--theme-section-hero-hook-primary-cta-outline-color)] focus-visible:[outline-offset:var(--theme-section-hero-hook-primary-cta-outline-offset)] focus-visible:[background:var(--theme-section-hero-hook-primary-cta-focus-bg)] focus-visible:[border-color:var(--theme-section-hero-hook-primary-cta-focus-border)] focus-visible:[color:var(--theme-section-hero-hook-primary-cta-focus-text-color)] focus-visible:shadow-[var(--theme-section-hero-hook-primary-cta-focus-shadow)] disabled:cursor-not-allowed disabled:[background:var(--theme-section-hero-hook-primary-cta-disabled-bg)] disabled:[border-color:var(--theme-section-hero-hook-primary-cta-disabled-border)] disabled:[color:var(--theme-section-hero-hook-primary-cta-disabled-text-color)] disabled:shadow-[var(--theme-section-hero-hook-primary-cta-disabled-shadow)] disabled:[transform:none]";

export const stickyBarPrimaryButtonClassName =
  "font-button inline-flex items-center justify-center gap-[var(--theme-section-sticky-bar-primary-cta-gap)] border text-center no-underline [border-width:var(--theme-section-sticky-bar-primary-cta-border-width)] [border-radius:var(--theme-section-sticky-bar-primary-cta-rest-radius)] [background:var(--theme-section-sticky-bar-primary-cta-rest-bg)] [border-color:var(--theme-section-sticky-bar-primary-cta-rest-border)] px-[var(--theme-section-sticky-bar-primary-cta-padding-x)] py-[var(--theme-section-sticky-bar-primary-cta-padding-y)] [color:var(--theme-section-sticky-bar-primary-cta-rest-text-color)] [font-family:var(--theme-section-sticky-bar-primary-cta-rest-font-family)] [font-size:var(--theme-section-sticky-bar-primary-cta-rest-font-size)] [font-weight:var(--theme-section-sticky-bar-primary-cta-rest-font-weight)] [letter-spacing:var(--theme-section-sticky-bar-primary-cta-rest-letter-spacing)] [line-height:var(--theme-section-sticky-bar-primary-cta-rest-line-height)] [min-height:var(--theme-section-sticky-bar-primary-cta-min-height)] [text-transform:var(--theme-section-sticky-bar-primary-cta-rest-text-transform)] shadow-[var(--theme-section-sticky-bar-primary-cta-rest-shadow)] transition-all duration-[var(--theme-section-sticky-bar-primary-cta-motion-duration)] ease-[var(--theme-section-sticky-bar-primary-cta-motion-easing)] hover:[background:var(--theme-section-sticky-bar-primary-cta-hover-bg)] hover:[border-color:var(--theme-section-sticky-bar-primary-cta-hover-border)] hover:[color:var(--theme-section-sticky-bar-primary-cta-hover-text-color)] hover:shadow-[var(--theme-section-sticky-bar-primary-cta-hover-shadow)] hover:[transform:var(--theme-section-sticky-bar-primary-cta-motion-transform)] focus-visible:outline focus-visible:outline-[var(--theme-section-sticky-bar-primary-cta-border-width)] focus-visible:outline-[var(--theme-section-sticky-bar-primary-cta-outline-color)] focus-visible:[outline-offset:var(--theme-section-sticky-bar-primary-cta-outline-offset)] focus-visible:[background:var(--theme-section-sticky-bar-primary-cta-focus-bg)] focus-visible:[border-color:var(--theme-section-sticky-bar-primary-cta-focus-border)] focus-visible:[color:var(--theme-section-sticky-bar-primary-cta-focus-text-color)] focus-visible:shadow-[var(--theme-section-sticky-bar-primary-cta-focus-shadow)] disabled:cursor-not-allowed disabled:[background:var(--theme-section-sticky-bar-primary-cta-disabled-bg)] disabled:[border-color:var(--theme-section-sticky-bar-primary-cta-disabled-border)] disabled:[color:var(--theme-section-sticky-bar-primary-cta-disabled-text-color)] disabled:shadow-[var(--theme-section-sticky-bar-primary-cta-disabled-shadow)] disabled:[transform:none]";

export const offerStackPrimaryButtonClassName =
  "font-button inline-flex items-center justify-center gap-[var(--theme-section-offer-stack-primary-cta-gap)] border text-center no-underline [border-width:var(--theme-section-offer-stack-primary-cta-border-width)] [border-radius:var(--theme-section-offer-stack-primary-cta-rest-radius)] [background:var(--theme-section-offer-stack-primary-cta-rest-bg)] [border-color:var(--theme-section-offer-stack-primary-cta-rest-border)] px-[var(--theme-section-offer-stack-primary-cta-padding-x)] py-[var(--theme-section-offer-stack-primary-cta-padding-y)] [color:var(--theme-section-offer-stack-primary-cta-rest-text-color)] [font-family:var(--theme-section-offer-stack-primary-cta-rest-font-family)] [font-size:var(--theme-section-offer-stack-primary-cta-rest-font-size)] [font-weight:var(--theme-section-offer-stack-primary-cta-rest-font-weight)] [letter-spacing:var(--theme-section-offer-stack-primary-cta-rest-letter-spacing)] [line-height:var(--theme-section-offer-stack-primary-cta-rest-line-height)] [min-height:var(--theme-section-offer-stack-primary-cta-min-height)] [text-transform:var(--theme-section-offer-stack-primary-cta-rest-text-transform)] shadow-[var(--theme-section-offer-stack-primary-cta-rest-shadow)] transition-all duration-[var(--theme-section-offer-stack-primary-cta-motion-duration)] ease-[var(--theme-section-offer-stack-primary-cta-motion-easing)] hover:[background:var(--theme-section-offer-stack-primary-cta-hover-bg)] hover:[border-color:var(--theme-section-offer-stack-primary-cta-hover-border)] hover:[color:var(--theme-section-offer-stack-primary-cta-hover-text-color)] hover:shadow-[var(--theme-section-offer-stack-primary-cta-hover-shadow)] hover:[transform:var(--theme-section-offer-stack-primary-cta-motion-transform)] focus-visible:outline focus-visible:outline-[var(--theme-section-offer-stack-primary-cta-border-width)] focus-visible:outline-[var(--theme-section-offer-stack-primary-cta-outline-color)] focus-visible:[outline-offset:var(--theme-section-offer-stack-primary-cta-outline-offset)] focus-visible:[background:var(--theme-section-offer-stack-primary-cta-focus-bg)] focus-visible:[border-color:var(--theme-section-offer-stack-primary-cta-focus-border)] focus-visible:[color:var(--theme-section-offer-stack-primary-cta-focus-text-color)] focus-visible:shadow-[var(--theme-section-offer-stack-primary-cta-focus-shadow)] disabled:cursor-not-allowed disabled:[background:var(--theme-section-offer-stack-primary-cta-disabled-bg)] disabled:[border-color:var(--theme-section-offer-stack-primary-cta-disabled-border)] disabled:[color:var(--theme-section-offer-stack-primary-cta-disabled-text-color)] disabled:shadow-[var(--theme-section-offer-stack-primary-cta-disabled-shadow)] disabled:[transform:none]";

export const captureModalPrimaryButtonClassName =
  "font-button inline-flex items-center justify-center gap-[var(--theme-section-capture-modal-primary-cta-gap)] border text-center no-underline [border-width:var(--theme-section-capture-modal-primary-cta-border-width)] [border-radius:var(--theme-section-capture-modal-primary-cta-rest-radius)] [background:var(--theme-section-capture-modal-primary-cta-rest-bg)] [border-color:var(--theme-section-capture-modal-primary-cta-rest-border)] px-[var(--theme-section-capture-modal-primary-cta-padding-x)] py-[var(--theme-section-capture-modal-primary-cta-padding-y)] [color:var(--theme-section-capture-modal-primary-cta-rest-text-color)] [font-family:var(--theme-section-capture-modal-primary-cta-rest-font-family)] [font-size:var(--theme-section-capture-modal-primary-cta-rest-font-size)] [font-weight:var(--theme-section-capture-modal-primary-cta-rest-font-weight)] [letter-spacing:var(--theme-section-capture-modal-primary-cta-rest-letter-spacing)] [line-height:var(--theme-section-capture-modal-primary-cta-rest-line-height)] [min-height:var(--theme-section-capture-modal-primary-cta-min-height)] [text-transform:var(--theme-section-capture-modal-primary-cta-rest-text-transform)] shadow-[var(--theme-section-capture-modal-primary-cta-rest-shadow)] transition-all duration-[var(--theme-section-capture-modal-primary-cta-motion-duration)] ease-[var(--theme-section-capture-modal-primary-cta-motion-easing)] hover:[background:var(--theme-section-capture-modal-primary-cta-hover-bg)] hover:[border-color:var(--theme-section-capture-modal-primary-cta-hover-border)] hover:[color:var(--theme-section-capture-modal-primary-cta-hover-text-color)] hover:shadow-[var(--theme-section-capture-modal-primary-cta-hover-shadow)] hover:[transform:var(--theme-section-capture-modal-primary-cta-motion-transform)] focus-visible:outline focus-visible:outline-[var(--theme-section-capture-modal-primary-cta-border-width)] focus-visible:outline-[var(--theme-section-capture-modal-primary-cta-outline-color)] focus-visible:[outline-offset:var(--theme-section-capture-modal-primary-cta-outline-offset)] focus-visible:[background:var(--theme-section-capture-modal-primary-cta-focus-bg)] focus-visible:[border-color:var(--theme-section-capture-modal-primary-cta-focus-border)] focus-visible:[color:var(--theme-section-capture-modal-primary-cta-focus-text-color)] focus-visible:shadow-[var(--theme-section-capture-modal-primary-cta-focus-shadow)] disabled:cursor-not-allowed disabled:[background:var(--theme-section-capture-modal-primary-cta-disabled-bg)] disabled:[border-color:var(--theme-section-capture-modal-primary-cta-disabled-border)] disabled:[color:var(--theme-section-capture-modal-primary-cta-disabled-text-color)] disabled:shadow-[var(--theme-section-capture-modal-primary-cta-disabled-shadow)] disabled:[transform:none]";
