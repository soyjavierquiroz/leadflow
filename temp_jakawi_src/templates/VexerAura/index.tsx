...
type TemplateVexerAuraProps = LandingTemplateProps & {
  uiConfig?: UIConfig
  vexer?: unknown
  product?: unknown
}

function TemplateVexerAura(props: TemplateVexerAuraProps) {
  ...
  return (
    <main className={styles.page}>
      <Marquee {...marqueeConfig} variant="dark" />
...
export { TemplateVexerAura, TemplateVexerAura as VexerAura }
export type { TemplateVexerAuraProps }
export default TemplateVexerAura
